...
select ST_TABLA_NEV , st_oszlop_nev   
from dw_master_table
where ST_TABLA_NEV ='enw_BankKivonatJogcim'
and  st_fk_tabla is not null
=>
ST_TABLA_NEV	ST_OSZLOP_NEV
enw_BankKivonatJogcim	UpdateDateTime
--- select 'enw_BankKivonatJogcim 	UpdateDateTime' tbl, count(1) as db from enw_BankKivonatJogcim where UpdateDateTime = -1
--
DECLARE
